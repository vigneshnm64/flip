...
import Buttonmodule from './buttonmodule.css'
...
const images = [
  {
    url: 'https://media.istockphoto.com/photos/women-using-laptop-computer-picture-id1222160402',
    title: 'USER',
    width: '40%',
  },
  {
...
export default function ButtonBases() {
  return (
    <div className='full'>
    <Box classname='but' sx={{ display: 'flex', flexWrap: 'wrap', 
     minWidth: 300, width: '100%',marginTop:'4px',
     backgroundColor:'red',justifyContent:'space-between'}}>
      {images.map((image) => (
        <ImageButton
          focusRipple
          key={image.title}
